        ...
        <div className={cx("header-container")}>
          ...
          <div className={cx("right-header")}>
            <div className={cx("input-search")}>
              ...
              {!isLoading ? (
                <i
                  className={cx("icon-search", "fa-solid fa-magnifying-glass")}
                ></i>
              ) : (
                <i className={cx("fa-solid fa-spinner", "icon-loading")} />
              )}
              {products != null && (
                <ProductSearch
                  products={products}
            ...
            {userLogin &&
              (location.pathname !== "/favorite" ? (
                <Link to="/favorite" className={cx("favorite-wrapper")}>
                ...
                <div className={cx("wrapper-active")}>
                  <span className={cx("favorite-quantity-active")}>
                    {listId.length || 0}
                  </span>
                  <i
                    className={cx("icon-heart", "fa-solid fa-heart", "active")}
                  ></i>
                </div>
              ))}
            {userLogin ? (
              <Link to="/cart" className={cx("cart-icon")}>
                ...
                >
                  {listProductId?.reduce((sum, elm) => sum + elm.quantity, 0) ||
                    0}
                </span>
                <AddShoppingCartIcon
            ...
            {userLogin && (
              ...
              >
                <span className={cx("user-info")}>
                  <Avatar
                    src={userLogin?.user?.url || defaultAvatar}
                    alt={userLogin?.user?.avatar || "Default Avatar"}
                    width="32"
                    height="32"
                  />
                </span>
