    ...
    return (
        <div className={cx("menu-manager-container")}>
            <TreeView
                ...
                defaultSelected={
                    location.pathname.includes("/profile") ? "5" : "null"
                }
            ...
            <TreeView
                ...
                defaultSelected={
                    location.pathname.includes("/returns") ? "10" : null
                }
                onNodeSelect={handleSelectNode}
                selected={selectedNode}
            >
                <StyledTreeItem
                    nodeId="9"
                    labelText="Manage Orders"
                    labelIcon={ManageHistoryIcon}
                >
                    <StyledTreeItem
                        nodeId="10"
                        labelText="Reviews"
