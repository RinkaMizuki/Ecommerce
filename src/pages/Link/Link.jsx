...
const Link = () => {
  ...
  const handleFindProviderByName = (providerName = "") => {
    return currentUser.userLogins?.find(
      (ul) => ul.loginProvider.toLowerCase() === providerName.toLowerCase()
    );
  };
              ...
              <div className={cx("provider-info")}>
                {handleFindProviderByName(googleProvider) ? (
                  <>
                    <Avatar
                      src={
                        handleFindProviderByName(googleProvider)?.accountAvatar
                      }
                    />
                    <p className={cx("account-name")}>
                      {handleFindProviderByName(googleProvider)?.accountName}
                    </p>
                  </>
                ) : (
                  <p className={cx("account-name")}>
                    Haven't linked Google account yet
                  </p>
                )}
              </div>
              {handleFindProviderByName(googleProvider) ? (
                <Popup
                  trigger={
                    handleFindProviderByName(googleProvider)?.isUnlink && (
                      <Button className={cx("btn-link-provider")}>
                        Unlink
                      </Button>
                    )
                  }
                  ...
                  content={
                    <p className={cx("content-text")}>
                      You want to unlink the account{" "}
                      <span>
                        {handleFindProviderByName(googleProvider)?.accountName}
                      </span>
                      ?
                ...
                <Button
                  className={cx("btn-link-provider")}
              ...
              <div className={cx("provider-info")}>
                {handleFindProviderByName(facebookProvider) ? (
                  <>
                    ...
                    />
                    <p className={cx("account-name")}>
                      {handleFindProviderByName(facebookProvider)?.accountName}
                    </p>
                  </>
                ) : (
                  <p className={cx("account-name")}>
                    Haven't linked Facebook account yet
                  </p>
                )}
              </div>
              {handleFindProviderByName(facebookProvider) ? (
                <Popup
                  ref={popupRef}
                  trigger={
                    handleFindProviderByName(facebookProvider)?.isUnlink && (
                      <Button className={cx("btn-link-provider")}>
                        Unlink
                      </Button>
                    )
            ...
            <div className={cx("provider-info-wrapper")}>
              <div className={cx("provider-info")}>
                {handleFindProviderByName("0987654321") ? (
                  ...
                  <p className={cx("account-name")}>
                    Haven't linked Phone Number yet
                  </p>
                )}
              </div>
              {handleFindProviderByName("0987654321") ? (
                <Button className={cx("btn-link-provider")}>Unlink</Button>
              ) : (
                <Button className={cx("btn-link-provider")}>
                  <svg
                    aria-hidden="true"
            ...
            <div className={cx("provider-info-wrapper")}>
              <div className={cx("provider-info")}>
                <input
                  ...
                  name="facebook"
                  id="facebook"
                  placeholder="Eg. https://www.facebook.com/mtstore"
                />
              </div>
              {true ? (
                <Button className={cx("btn-link-provider")}>Edit</Button>
              ) : (
                <div className={cx("btn-link-change")}>
            ...
            <div className={cx("provider-info-wrapper")}>
              <div className={cx("provider-info")}>
                <input
                  ...
                  name="youtube"
                  id="youtube"
                  placeholder="Eg. https://www.youtube.com/mtstore"
                />
              </div>
              {true ? (
                <Button className={cx("btn-link-provider")}>Edit</Button>
            ...
            <div className={cx("provider-info-wrapper")}>
              <div className={cx("provider-info")}>
                <input
                  ...
                  name="linkedin"
                  id="linkedin"
                  placeholder="Eg. https://www.linkedin.com/in/mtstore"
                />
              </div>
              {true ? (
                <Button className={cx("btn-link-provider")}>Edit</Button>
            ...
            <div className={cx("provider-info-wrapper")}>
              <div className={cx("provider-info")}>
                <input
                  ...
                  name="instagram"
                  id="instagram"
                  placeholder="Eg. https://www.instagram.com/mtstore"
                />
              </div>
              {true ? (
                <Button className={cx("btn-link-provider")}>Edit</Button>
            ...
            <div className={cx("provider-info-wrapper")}>
              <div className={cx("provider-info")}>
                <input
                  ...
                  name="twitter"
                  id="twitter"
                  placeholder="Eg. https://www.twitter.com/mtstore"
                />
              </div>
              {true ? (
                <Button className={cx("btn-link-provider")}>Edit</Button>
