...
const Link = () => {
    ...
    const handleFindProviderByName = (providerName = "") => {
        return currentUser.userLogins?.find(
            (ul) =>
                ul.loginProvider.toLowerCase() === providerName.toLowerCase()
        );
    };
            ...
            <div className={cx("link-account-wrapper")}>
                ...
                <div className={cx("link-info-wrapper")}>
                    <div className={cx("link-info-item")}>
                        <h2 className={cx("provider-title")}>
                            Link {googleProvider}
                        </h2>
                            ...
                            {handleFindProviderByName(googleProvider) ? (
                                <Popup
                                    ...
                                    contentStyle={{
                                        ...
                                        border: "0",
                                        animation:
                                            ".3s cubic-bezier(.38,.1,.36,.9) forwards a",
                                    }}
                                    header={
                                        <svg
                        ...
                        <div className={cx("provider-info-wrapper")}>
                            ...
                            {true ? (
                                ...
                                <div className={cx("btn-link-change")}>
                                    <Button className={cx("btn-link-save")}>
                                        Save
                                    </Button>
                                    <Button className={cx("btn-link-provider")}>
                                        Cancel
