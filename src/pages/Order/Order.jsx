            ...
            >
              <div className="card-header px-4 py-5 d-flex justify-content-between align-items-center">
                <h5 className="text-muted mb-0">
                  ...
                  <span style={{ color: "#a8729a" }}>{userLogin.userName}</span>
                  !
                </h5>
                <div className="d-flex justify-content-center align-items-center gap-3">
                  <span className="text-muted">
                    {listOrder?.length ? activeIndex : 0}/{listOrder?.length}
                  </span>
                  <NavigateBtn
                    refs={{
                      prevRef,
              ...
              {listOrder.length ? (
                        ...
                        <div className="card-body p-4">
                          <div className="d-flex justify-content-between align-items-center mb-4">
                            {orderPathName === "/manager/orders" ? (
                              ...
                              >
                                Orders <i className="fa-solid fa-receipt"></i>
                              </p>
                            ) : orderPathName === "/manager/cancels" ? (
                              <p
                                className="lead fw-normal mb-0"
                                style={{
                                  color: "#a8729a",
                            ...
                            <p className="small text-muted mb-0">
                              Order Voucher :{" "}
                              {order.coupon?.couponCode || "No voucher"}
                            </p>
                          </div>
                          ...
                          <div className="row d-flex align-items-center mb-4">
                            <div className="col-md-12">
                              ...
                              >
                                {Array.from({
                                  length: ORDER_STATE[order.status],
                                })
                                  .fill("")
                                  .map((_, index) => (
                                    <div
                          ...
                          <div className="d-flex flex-column gap-2 mt-3">
                            ...
                            <div className="d-flex justify-content-between mb-5">
                              <p className="text-muted mb-0">
                                Recepits Voucher : {order.couponId}
                              </p>
                              <p className="text-muted mb-0">
                ...
                >
                  ...
                  >
                    You don't have any {orderPathName.split("/").pop()} order.
                  </span>
                </Box>
              )}
            </div>
